...
public class ApplicationRules {
    ...
    static ArchRule controller_should_be_annotated_with_rest_controller =
            ArchRuleDefinition.classes().that()
                    .haveSimpleNameContaining("Controller")
                    .should().beAnnotatedWith(RestClientTest.class);
    ...
    @ArchTest
    static ArchRule controller_should_be_inject_only_interactor_class =
            ArchRuleDefinition.classes().that()
                    .haveSimpleNameContaining("Controller")
                    .should(ArchConditionCustom.injectOnlyType("Interactor"));
